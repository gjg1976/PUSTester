...
{
    public partial class FormRequestST23_07 : Form
    {
        ...
        public FormRequestST23_07()
        {
            ...
            if (new_payload.Count > 0)
            {
                ...
                textBoxSearchString.Text = System.Text.Encoding.UTF8.GetString(filename);
        ...
        {
            payload.Clear();
            string searchPath = textBoxFilePath.Text;
            string searchString = textBoxSearchString.Text;
