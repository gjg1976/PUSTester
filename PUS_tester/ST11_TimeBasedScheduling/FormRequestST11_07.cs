...
{
    public partial class FormRequestST11_07 : Form
    {
        ...
        public FormRequestST11_07()
        {
            ...
            if(new_payload.Count > 0)
            {
                ...
                var currentValueFieldOffset = numericUpDownOffset.GetType().GetField("currentValue", BindingFlags.Instance | BindingFlags.NonPublic);
                if (currentValueFieldOffset != null)
                {
                    ...
                    currentValueFieldOffset.SetValue(numericUpDownOffset, Convert.ToDecimal(offsetTime));
                    numericUpDownOffset.Text = offsetTime.ToString();
                }
                ...
                {
                    Byte[] payload = { new_payload[4], new_payload[5] };
                    if (BitConverter.IsLittleEndian)
                        Array.Reverse(payload);
                ...
                for (int i = 0; i < N; i++, offset +=6)
                {
                    ...
                    tmpSourceLabel.Location = new System.Drawing.Point(60, i * 30 + 212);
                    ...
                    tmpSource.Location = new System.Drawing.Point(150, i * 30 + 210);
                    ...
                    tmpAppIDLabel.Location = new System.Drawing.Point(220, i * 30 + 212);
                    ...
                    tmpAppID.Location = new System.Drawing.Point(290, i * 30 + 210);
                    ...
                    tmpSeqIDLabel.Location = new System.Drawing.Point(360, i * 30 + 212);
                    ...
                    tmpSeqID.Location = new System.Drawing.Point(450, i * 30 + 210);
