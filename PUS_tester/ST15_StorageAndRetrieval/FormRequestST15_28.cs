    ...
    public partial class FormRequestST15_28 : Form
    {
        ...
        public FormRequestST15_28()
        {
            ...
            if (new_payload.Count > 0)
            {
                ...
                numericUpDownVC.Value = new_payload[offset];
            }
        }
        ...
        void updatePayloadAndGUI()
        {
            ...
            payload.Add(decimal.ToByte(numericUpDownVC.Value));
        ...
        private void numericUpDownVC_ValueChanged(object sender, EventArgs e)
        {
            updatePayloadAndGUI();
        }
    }
